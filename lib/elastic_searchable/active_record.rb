  ...
  module ActiveRecord
    ...
    module InstanceMethods
      ...
      def index_in_elastic_search(lifecycle = nil)
        ElasticSearchable.assert_ok_response ElasticSearchable.put "/#{self.class.index_name}/#{self.class.elastic_options[:type]}/#{self.id}", :body => self.indexed_json_document.to_json
